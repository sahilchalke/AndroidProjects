package com.example.sahil.superheropower.Fragments;
...
import com.example.sahil.superheropower.MainActivity.MainActivity;
...
public class MainFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chooseBtn = (Button)view.findViewById(R.id.powerBtn);
    ...
    public void onClick(View view) {
        ...
        if(btn==accidentBtn){
            ...
            accidentBtn.setCompoundDrawablesWithIntrinsicBounds(leftDrawable,0,R.drawable.item_selected,0);
            ...
            mutationBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.atomic,0,R.drawable.item_selected,0);
            bornBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rocket,0,0,0);
        }
        else if(btn==bornBtn){
            ...
            accidentBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.lightning,0,0,0);
            mutationBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.atomic,0,0,0);
            bornBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rocket,0,R.drawable.item_selected,0);
        }
    }
